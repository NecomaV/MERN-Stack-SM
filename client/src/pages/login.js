...
function Login() {
  ...
  return (
    <div className='w-full h-screen flex justify-center items-center bg-indigo-50'>
      <form className="bg-[url('./images/endless-constellation.svg')] w-full max-w-5xl bg-purple-50 rounded-xl shadow-2xl shadow-indigo-700 flex flex-col items-center p-20 h-4/6 drop-shadow-3xl">
        <div className="mt-20">
          ...
          <div className="md:flex md:items-center w-full">
            ...
            <div className="md:w-2/3">
              <button className="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white text-2xl font-bold py-2 px-4 rounded w-48 transition-all" type="button" disabled={email && password ? false : true}>
                Login
              </button>
            </div>
          </div>
